...
module USB_CDC_FIFO_ahbl (
        ...
        always @(posedge HCLK or negedge HRESETn) if(~HRESETn) IM_REG <= 0; else if(ahbl_we & (last_HADDR[15:0]==IM_REG_ADDR)) IM_REG <= HWDATA[4-1:0];
        ...
        always @(posedge HCLK or negedge HRESETn) if(~HRESETn) ICR_REG <= 4'b0; else if(ahbl_we & (last_HADDR[15:0]==ICR_REG_ADDR)) ICR_REG <= HWDATA[4-1:0]; else ICR_REG <= 4'd0;
